...
function getCharacterMap() {
    if(!characterMap_) {
        ...
        characterMap_.set('spider-man', {
            id: 1009610,
            name: 'spider-man',
            resourceUri: this.settings.baseUri + 'v1/characters/spider-man',
        ...
        characterMap_.set('hulk', {
            id: 1009351,
            name: 'hulk',
            resourceUri: this.settings.baseUri + 'v1/characters/hulk',
        ...
        characterMap_.set('captain-america', {
            ...
            resourceUri: this.settings.baseUri + 'v1/characters/captain-america',
        ...
        characterMap_.set('iron-man', {
            id: 1009368,
            name: 'iron-man',
            resourceUri: this.settings.baseUri + 'v1/characters/iron-man',
        ...
        characterMap_.set('thor', {
            id: 1009664,
            name: 'thor',
            resourceUri: this.settings.baseUri + 'v1/characters/thor',
        ...
        characterMap_.set('wolverine', {
            id: 1009718,
            name: 'wolverine',
            resourceUri: this.settings.baseUri + 'v1/characters/wolverine',
        ...
        characterMap_.set('storm', {
            id: 1009629,
            name: 'storm',
            resourceUri: this.settings.baseUri + 'v1/characters/storm',
        ...
        characterMap_.set('jean-grey', {
            id: 1009496,
            name: 'jean-grey',
            resourceUri: this.settings.baseUri + 'v1/characters/jean-grey',
        ...
        characterMap_.set('gambit', {
            id: 1009313,
            name: 'gambit',
            resourceUri: this.settings.baseUri + 'v1/characters/gambit',
        ...
        characterMap_.set('cyclops', {
            id: 1009257,
            name: 'cyclops',
            resourceUri: this.settings.baseUri + 'v1/characters/cyclops',

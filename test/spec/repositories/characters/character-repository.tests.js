describe('CharacterRepository Tests', function () {
    ...
    beforeEach(function () {
        ...
        characterRepository.httpClient_ = {
    ...
    describe('getCharacterData()', function () {
        ...
        it('should throw exception when null id', function (done) {
            var getCharacterData = function () {
                characterRepository.getCharacterData(null, timeStamp, publicKey, hash, function (body) {
                });
            };
        ...
        it('should throw exception when null timeStamp', function (done) {
            var getCharacterData = function () {
                characterRepository.getCharacterData(1234, null, publicKey, hash, function (body) {
                });
            };
        ...
        it('should throw exception when null publicKey', function (done) {
            var getCharacterData = function () {
                characterRepository.getCharacterData(1234, timeStamp, null, hash, function (body) {
                });
            };
        ...
        it('should throw exception when null hash', function (done) {
            var getCharacterData = function () {
                characterRepository.getCharacterData(1234, timeStamp, publicKey, null, function (body) {
                });
            };
        ...
        it('should throw exception when callback not passed', function (done) {
            var getCharacterData = function () {
                characterRepository.getCharacterData(1234, timeStamp, publicKey, hash);
            };
        ...
        it('should throw exception when null callback', function (done) {
            var getCharacterData = function () {
                characterRepository.getCharacterData(1234, timeStamp, publicKey, hash, null);
            };
        ...
        it('should throw exception when callback with no params', function (done) {
            var getCharacterData = function () {
                characterRepository.getCharacterData(1234, timeStamp, publicKey, hash, function () {
                });
            };
        ...
        it('should throw exception when callback with two params', function (done) {
            var getCharacterData = function () {
                characterRepository.getCharacterData(1234, timeStamp, publicKey, hash, function (one, two) {
                });
            };

describe('CredentialsService Tests', function () {
    ...
    beforeEach(function () {
        ...
        credentialsService.keyRepository_ = {
            getConfig: function () {
                return keyConfigMock
            }
        };
        credentialsService.cryptoService_ = {
            createHash: function (algorithm) {
                return {
                    update: function (data) {
                    },
                    digest: function (format) {
                        return 'b8fcdc8fd05f1bd62d6c7aa6736afe31'
                    }
                }
            }
        };
    ...
    describe('lookupCredentials', function () {
        ...
        it('should throw exception when keyRepository throws exception', function (done) {
            ...
            var lookupCredentials = function () {
                credentialsService.lookupCredentials();
            }
